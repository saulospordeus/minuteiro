defmodule MinuteiroWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MinuteiroWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MinuteiroWeb.Gettext, "errors", msg, opts)
    end
  end
